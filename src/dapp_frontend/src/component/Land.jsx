  ...
  return (
    <div className='max-w-screen bg-white overflow-x-hidden'>
      ...
      <ul className="list-none mx-auto my-12 flex flex-col sm:flex-row items-center gap-8 w-5/6">
        <li className=' bg-teal-100 p-4 w-5/6'>Secure and private: HealthPass ensures that your health records are securely stored and accessible only by you and authorized healthcare providers</li>
        <li className=' bg-teal-100 p-4 w-5/6'>Blockchain technology: Utilizes blockchain technology for transparent and tamper-proof record keeping, ensuring the integrity of your health data.</li>
        <li className=' bg-teal-100 p-4  w-5/6'>User-controlled access: Allows you to control who can access your health records, ensuring that your data is only shared with your consent.</li>
